...
const scriptsToSet = {
    "lint:css":
        'stylelint --cache --config stylelint.config.mjs --cache-strategy content --cache-location .cache/stylelintcache "{src,docs}/**/*.css" --custom-formatter stylelint-formatter-pretty && echo "Stylelint done!"',
    "lint:css:fix":
        'stylelint --cache --config stylelint.config.mjs --cache-strategy content --cache-location .cache/stylelintcache "{src,docs}/**/*.css" --custom-formatter stylelint-formatter-pretty --fix && echo "Stylelint done!"',
    "lint:prettier":
